...
void resend_message(int sockfd,struct temp_buf*temp_buff,struct sockaddr_in *serv_addr,socklen_t len, double loss_prob);
void send_syn(int sockfd,struct sockaddr_in *serv_addr, socklen_t len, double loss_prob);
void send_message(int sockfd, struct sockaddr_in *cli_addr, socklen_t len, struct temp_buf temp_buff, char *data, char command, double loss_prob);
...
void rcv_ack_list_in_window(struct temp_buf temp_buff,struct sel_repeat *shm);
